...
import com.joinsmile.community.utils.FileManager;
...
public class ProgressWebView extends WebView {
    ...
    private static Uri getOutputMediaFileUri() {
        return Uri.fromFile(FileManager.getImgFile(CommunityApplication.getTicketApplication().getApplicationContext()));
    }
