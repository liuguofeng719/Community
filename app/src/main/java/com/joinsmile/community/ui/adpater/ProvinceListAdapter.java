...
public class ProvinceListAdapter extends BaseAdapter implements PinnedHeaderListView.PinnedHeaderAdapter, SectionIndexer, OnScrollListener {
    private List<ProvinceVo> mList;
    private int mLocationPosition = -1;

    private List<Integer> mPositions;
    private List<String> mSections;

    public ProvinceListAdapter(List<ProvinceVo> mList) {
        this.mList = mList;
        initDateHead();
    }
    ...
    public void updateView(List<ProvinceVo> cityVoList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ProvinceVo city = mList.get(position);
        ...
        holder.cityName.setText(city.getProvinceName());
        holder.cityName.setTag(city.getProvinceId());
        return convertView;
    }
