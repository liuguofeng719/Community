...
public class CityAddressActivity extends BaseActivity implements SiderBar.OnTouchingLetterChangedListener {
    ...
    public void locationCityName() {
        if (!TextUtils.isEmpty(cityName)) {
            ...
            bundle.putString("cityName", bundleData.getString("provinceName") + tv_location_city_name.getText().toString());
            readyGoThenKill_CLEAR_TOP_SINGLE_TOP(AddDeliveryAddressActivity.class, bundle);
        }
    }
    ...
    protected void initViewsAndEvents() {
        ...
        this.lv_city.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bundle.putString("cityName", bundleData.getString("provinceName") + textView.getText().toString());
                readyGoThenKill_CLEAR_TOP_SINGLE_TOP(AddDeliveryAddressActivity.class, bundle);
            }
        });
    ...
    private void getCity() {
        ...
        callCityList = getApisNew().getAdministrativeCities(bundleData.getString("provinceId")).clone();
        callCityList.enqueue(new Callback<CityListResp<List<CityVo>>>() {
            ...
            public void onResponse(Call<CityListResp<List<CityVo>>> call, Response<CityListResp<List<CityVo>>> response) {
                ...
                if (response.isSuccessful() && response.body() != null && response.body().isSuccessfully()) {
                    ...
                    CommonUtils.make(CityAddressActivity.this, CommonUtils.getCodeToStr(response.code()));
                }
            }
            ...
            public void onFailure(Call<CityListResp<List<CityVo>>> call, Throwable t) {
                ...
                if ("timeout".equals(t.getMessage())) {
                    CommonUtils.make(CityAddressActivity.this, "网络请求超时");
                }
            }
        });
    }
